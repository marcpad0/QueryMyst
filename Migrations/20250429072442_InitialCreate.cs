        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EarnedOn = table.Column<DateTime>(type: "TEXT", nullable: false),
                    NotificationDisplayed = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    MysteryId = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MysteryDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MysteryDetails_Mysteries_MysteryId",
                        column: x => x.MysteryId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserSolution = table.Column<string>(type: "text", nullable: false),
                    AttemptsCount = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserMysteries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserMysteries_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserMysteries_Mysteries_MysteryId",
                        column: x => x.MysteryId,
                        principalTable: "Mysteries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserMysteries_MysteryId",
                table: "UserMysteries",
                column: "MysteryId");

            migrationBuilder.CreateIndex(
                name: "IX_UserMysteries_UserId",
                table: "UserMysteries",
                column: "UserId");
        }
